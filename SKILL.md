...
- 小于 10 条记录：使用 Inline Mode。不创建 `workdir`，直接按 `references/classification_options.json`、`references/topk_prompt.md`、`references/topk_io_contract.md` 和 `references/final_prompt.md` 在当前响应中返回结果。
